...
class ConversationStore:
    ...
    def ping(self) -> bool:
        ...
        try:
            ...
            # Readiness phải trả 503 thay vì để lỗi kết nối Redis làm endpoint
            # ném 500 và che mất trạng thái thực.
            return False
    ...
    def get_history(self, user_id: str) -> list[dict]:
        ...
        """
        key = self._key(user_id)
        return [json.loads(message) for message in self.client.lrange(key, 0, -1)]
